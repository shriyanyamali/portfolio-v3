...
const timeline: TimelineItem[] = [
  ...
  {
    id: 2,
    date: "June 2025 — Present | Remote",
    role: "Lab Member",
    org: "University of Michigan FP Lab",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    role: "Lab Member",
    org: "University of Delaware DIRLab",
  },
  {
    id: 6,
...
const stackItems: StackItem[] = [
  // { id: 1, src: "/logos/java-logo.svg", alt: "Java logo" },
  { id: 2, src: "/logos/python-logo.svg", alt: "Python logo" },
  // { id: 3, src: "/logos/ocaml-logo.svg", alt: "OCaml logo" },
  { id: 4, src: "/logos/js-logo.svg", alt: "JS logo" },
  { id: 5, src: "/logos/ts-logo.svg", alt: "TypeScript logo" },
  { id: 6, src: "/logos/html5-logo.svg", alt: "HTML5 logo" },
  { id: 7, src: "/logos/css3-logo.svg", alt: "CSS3 logo" },
  // { id: 8, src: "/logos/pandas-logo.svg", alt: "Pandas logo" },
  // { id: 9, src: "/logos/numpy-logo.svg", alt: "Numpy logo" },
  { id: 10, src: "/logos/nextjs-logo.svg", alt: "Next.js logo" },
  { id: 11, src: "/logos/react-logo.svg", alt: "React logo" },
  { id: 12, src: "/logos/framer-logo.svg", alt: "Framer   logo" },
  { id: 13, src: "/logos/tailwind-logo.svg", alt: "Tailwind CSS logo" },
